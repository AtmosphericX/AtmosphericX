...
# Installation Guide
---
This guide provides step-by-step instructions for installing AtmosphericX, including system requirements, OS specific steps, and troubleshooting tips. For additional support, join our [Discord Community](https://discord.gg/YAEjtzU3E8) for volunteer support.

::: info Documentation Notice
Please keep in mind that this project is **actively** being maintained and updated, so be sure to check for information and updates. The primary documentation page can be found [here](https://atmosx-secondary.scriptkitty.cafe/docs). Each instance will have it's own documentation as well which can be found at `/docs` on the respective instance. 
...
If you have questions for the developers, please feel free to reach out to the public [Discord server](https://discord.gg/YAEjtzU3E8).
