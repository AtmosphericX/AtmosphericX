...
3. If the issue persists, consider reaching out on our [Discord server](https://atmosphericx-discord.scriptkitty.cafe) for further assistance. Please make sure to include any error logs or messages you encounter.
:::
